...
This repository contains tools for capturing and analyzing Cursor on Target (CoT) calculation messages from generated by OpenAthena for Android from drone images and comparing these with ground control points (GCP) to validate the accuracy of terrain-raycast techniques used by OpenAthena software.
